...
<head>
   ...
   <title>Contactez HVNET CLIMATISATION société de peinture à Casablanca</title>

   <meta name="keywords" CONTENT="">

   <meta name="description"
      content="Pour tout problème de peinture à Casablanca et partout au Maroc, Contactez HVNET CLIMATISATION société de peinture à Casablanca">
   ...
   <!-- Link canonique -->
   <link rel="canonical" href="index.html/contactez-societe-peinture.php">
...
<body class="home">
   <div class="wrap">
               ...
               <div class="">
                  <nav class="collapse navbar-collapse menu ">
                     <ul class="nav navbar-nav sf-menu">
                        ...
                        <li><a href="blog-premiere-page-casablanca.html">BLOG</a></li>

                        <li><a id="current" href="contactez-societe-peinture.php">CONTACT</a></li>

                        <li><a href="devis-societe-peinture.php" id="btn-demandez-devis">DEMANDEZ DEVIS</a></li>
                     </ul>
                  </nav>
               </div>
      ...
      <!-- contact Start -->
      <div class="container">
         <h1 id="ctactcolor">Contactez HVNET CLIMATISATION pour votre travaux de peintures</h1>
         <main class="content">
                     ...
                     if (isset($_POST['sendEmailSubBtn'])) {
                        ...
                        if (
                           ...
                           if (mysqli_query($conn, $sqls)) {
                              ...
                              $subject = 'DEMANDE DE CONTACT HVNET CLIMATISATION';
            ...
            <div class="container">
               ...
               <div class="row">
                  <div class="col-lg-9 copyright">
                     &copy; Copyright 2014 - 2021 by <a href="index.html">WINBEST
                        PEINTURE</a>. Tous
                     droits réservés.
                  </div>
